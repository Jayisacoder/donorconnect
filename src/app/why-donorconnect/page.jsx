...
export default function WhyDonorConnectPage() {
  return (
    <div className="mx-auto max-w-4xl space-y-6 py-12 px-6">
      <h1 className="text-4xl font-bold text-gray-900">Why DonorConnect</h1>
      <p className="text-lg text-gray-700">A focused MVP built to move first-time donors to their second gift with clear data, guided actions, and automation.</p>
      <div className="space-y-4 text-gray-800">
        <section>
          <h2 className="text-xl font-semibold">Solution idea</h2>
        ...
        <section>
          <h2 className="text-xl font-semibold">Key features & rationale</h2>
        ...
        <section>
          <h2 className="text-xl font-semibold">Expected challenges & planning</h2>
