...
export default function AIPolicyPage() {
  return (
    <div className="mx-auto max-w-4xl space-y-6 py-12 px-6">
      <h1 className="text-4xl font-bold text-gray-900">AI Policy & Safeguards</h1>
      <p className="text-lg text-gray-700">How DonorConnect uses AI responsibly to assist, not replace, nonprofit staff.</p>
      <div className="space-y-4 text-gray-800">
        <section>
          <h2 className="text-xl font-semibold">Model & API</h2>
        ...
        <section>
          <h2 className="text-xl font-semibold">Data sent to AI</h2>
        ...
        <section>
          <h2 className="text-xl font-semibold">Prompt craft</h2>
        ...
        <section>
          <h2 className="text-xl font-semibold">Value to users</h2>
