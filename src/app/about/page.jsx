...
export default function AboutPage() {
  return (
    <div className="mx-auto max-w-4xl space-y-6 py-12 px-6">
      <h1 className="text-4xl font-bold text-gray-900">The Nonprofit Donor Problem</h1>
      <p className="text-lg text-gray-700">Nonprofits lose most first-time donors before a second gift. Disconnected data, manual follow-ups, and limited staff time create missed touchpoints that erode trust.</p>
      <div className="space-y-4 text-gray-800">
        ...
        <section>
          <h2 className="text-xl font-semibold">Consequences of inaction</h2>
        ...
        <section>
          <h2 className="text-xl font-semibold">How DonorConnect differs</h2>
