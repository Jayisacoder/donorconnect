...
export default function EvidencePage() {
  return (
    <div className="mx-auto max-w-4xl space-y-6 py-12 px-6">
      <h1 className="text-4xl font-bold text-gray-900">Evidence & Rubric</h1>
      <p className="text-lg text-gray-700">Links and notes to help assess the DonorConnect MVP.</p>
      <div className="space-y-6 text-gray-800">
        <section>
          <h2 className="text-xl font-semibold">CCC.1.3 Evidence</h2>
        ...
        <section>
          <h2 className="text-xl font-semibold">TS.6.2 Evidence</h2>
        ...
        <section>
          <h2 className="text-xl font-semibold">TS.6.3 Evidence</h2>
