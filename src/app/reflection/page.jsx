...
export default function ReflectionPage() {
  return (
    <div className="mx-auto max-w-4xl space-y-6 py-12 px-6">
      <h1 className="text-4xl font-bold text-gray-900">Reflection</h1>
      <div className="space-y-4 text-gray-800">
        <section>
          <h2 className="text-xl font-semibold">Biggest challenge</h2>
          <p>Balancing Next.js app router auth with Prisma multi-tenant filtering while keeping tests green and UI responsive.</p>
        </section>
        <section>
          <h2 className="text-xl font-semibold">What I would change with more time</h2>
        ...
        <section>
          <h2 className="text-xl font-semibold">How AI helped</h2>
